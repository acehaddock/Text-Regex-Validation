...
export class TextRegexValidation implements ComponentFramework.StandardControl<IInputs, IOutputs> {
     ...
     * @param objActualContainer If a control is marked control-type='standard', it will receive an empty div element within which it can render its content.
     */
    public init(context: ComponentFramework.Context<IInputs>, notifyOutputChanged: () => void, state: ComponentFramework.Dictionary, objActualContainer:HTMLDivElement)
    {
